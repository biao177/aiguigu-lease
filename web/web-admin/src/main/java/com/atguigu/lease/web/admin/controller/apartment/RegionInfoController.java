...
public class RegionInfoController {
    ...
    public Result<List<CityInfo>> listCityInfoByProvinceId(@RequestParam Long id) {
        LambdaQueryWrapper<CityInfo> cityInfoLambdaQueryWrapper = Wrappers.lambdaQuery();
        cityInfoLambdaQueryWrapper
    ...
    public Result<List<DistrictInfo>> listDistrictInfoByCityId(@RequestParam Long id) {
        LambdaQueryWrapper<DistrictInfo> districtInfoLambdaQueryWrapper = Wrappers.lambdaQuery();
        districtInfoLambdaQueryWrapper
